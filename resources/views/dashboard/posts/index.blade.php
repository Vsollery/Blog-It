            ...
            <tr>
                ...
                <td>
                    ...
                    <form action="/dashboard/posts/{{ $post->slug }}" method="post" class="d-inline">
                        @method('delete')
                        @csrf
                        <button class="badge bg-danger border-0" onclick="return confirm('Are you sure you want to delet this post?')"><span data-feather="trash" class="align-text-bottom"></span></button>
                    </form>
