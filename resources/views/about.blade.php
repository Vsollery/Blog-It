            ...
            <div class="col-md-12 col-xl-4">
                ...
                <div class="card" style="border-radius: 15px;">
                    <div class="card-body text-center">
                        <div class="mt-3 mb-4">
                            <img src="img/E-BLOG.png" class="rounded-circle img-fluid" style="width: 100px;" />
                        </div>
                        ...
                        <div class="d-flex justify-content-between text-center mt-5 mb-2">
                            ...
                            <div>
                                <p class="mb-2 h5">Number of Posts</p>
                                <p class="text-muted mb-0">{{ $user->posts->count() }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card" style="border-radius: 15px;">
                    <div class="card-body text-center">
                        ...
                        <h4 class="mb-2">E-BLOG</h4>
                        <p class="text-muted mb-4">Start Posting!</p>
